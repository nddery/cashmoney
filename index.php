    ...
    <footer class="clearfix">
      <div id="footercontent">
        ...
        <p class="floatleft box">
          Cashmoney is a data visualization of the NHL player's plus/minus score against their salary. The idea was to create a visually compelling method of analyzing player's performance and to easily spot overpaid/under performing player's.<br /><br />
          Higher bar represent player's with higher plus/minus score.<br />
          The darker the blue, the higher the salary.
        </p>
