...
# Licence:    GPL
#
# Screen scrape the NHL player statistics and gather relevant (for this project)
# information. Saves it all to a .tsv file.
#
...
# url = "http://www.nhl.com/ice/app?service=page&page=playerstatsprint&fetchKey=20102ALLSASAll&viewName=summary&sort=player.bioFirstNameLastName&pg="
# url = "http://www.nhl.com/ice/playerstats.htm?season=20112012&gameType=2&team=&position=S&country=&status=&viewName=summary&pg="
url = "http://www.nhl.com/ice/playerstats.htm?fetchKey=20122ALLSASALL&sort=player.bioFirstNameLastName&viewName=summary&pg="
...
for i in range(1, 29):
  ...
  for tr in rows:
    ...
    for td in cols:
      ...
      if (col == 1) or (col == 2) or (col == 3) or (col == 5) or (col == 6) or (col == 7) or (col == 8):
